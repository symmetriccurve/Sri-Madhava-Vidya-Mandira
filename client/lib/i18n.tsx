...
const dictionary: Record<Lang, Record<string, string>> = {
  en: {
    ...
    head_mistress_message: "Principal's Message",
    ...
    sangamma_attribution: "Principal, Primary Section",
    director: "Director",
  ...
  kn: {
    ...
    sangamma_attribution: "ಮುಖ್ಯ ಶಿಕ್ಷಕರು ಪ್ರಾಥಮಿಕ ಶಾಲೆ",
    director: "ನಿರ್ದೇಶಕರು",

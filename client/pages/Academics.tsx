    ...
    <main className="container mx-auto py-10">
      ...
      <section className="text-center mb-12">
        <h1 className="text-4xl font-bold text-brand-blue mb-4">
          {t("academics_page_title")}
        </h1>
        <p className="text-xl text-gray-600 mb-6">
          {t("academics_page_subtitle")}
        </p>
      ...
      <section className="mb-12">
        <h2 className="text-3xl font-bold text-center text-brand-blue mb-8">
          {t("academics_page_curriculum_overview")}
        </h2>
        <Tabs defaultValue="pre-primary" className="w-full">
          <TabsList className="grid w-full grid-cols-2 sm:grid-cols-4 h-auto">
            <TabsTrigger value="pre-primary">
              {t("academics_page_tab_pre_primary")}
            </TabsTrigger>
            <TabsTrigger value="primary">
              {t("academics_page_tab_primary")}
            </TabsTrigger>
            <TabsTrigger value="middle">
              {t("academics_page_tab_middle")}
            </TabsTrigger>
            <TabsTrigger value="high">
              {t("academics_page_tab_high")}
            </TabsTrigger>
          </TabsList>
      ...
      <section className="mb-12">
        <h2 className="text-3xl font-bold text-center text-brand-blue mb-8">
          {t("academics_page_co_curricular_title")}
        </h2>
              ...
              >
                ...
                <CardHeader className="pt-6">
                  <div className="flex justify-center mb-1">
                    <Badge className="bg-brand-orange text-white text-xs px-3 py-0.5 mb-2">
                      {t("academics_page_featured_badge")}
                    </Badge>
                  </div>
                  <div className="flex justify-center mb-3">
      ...
      <section className="mb-12">
        <div className="grid md:grid-cols-2 gap-8">
          <Card>
            <CardHeader>
              <CardTitle className="text-xl text-brand-blue">
                {t("academics_page_assessment_methods_title")}
              </CardTitle>
            </CardHeader>
            <CardContent>
          ...
          <Card>
            <CardHeader>
              <CardTitle className="text-xl text-brand-blue">
                {t("academics_page_academic_support_title")}
              </CardTitle>
            </CardHeader>
            <CardContent>
              <ul className="space-y-3 text-gray-700">
